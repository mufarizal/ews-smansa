...
<div class="mx-auto max-w-7xl">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <a href="{{ route('wali_kelas.perilaku-siswa.create') }}"
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-5 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('wali_kelas.perilaku-siswa.show', $item) }}"
                                        class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                        <i class="ti ti-eye text-base"></i>
                                    </a>
                                    <a href="{{ route('wali_kelas.perilaku-siswa.edit', $item) }}"
                                        class="rounded-lg p-2 text-blue-600 hover:bg-blue-50">
                                        <i class="ti ti-pencil text-base"></i>
                                    </a>
                                    <form method="POST" action="{{ route('wali_kelas.perilaku-siswa.destroy', $item) }}"
