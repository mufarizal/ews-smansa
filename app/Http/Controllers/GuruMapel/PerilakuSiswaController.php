...
class PerilakuSiswaController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('guru_mapel.perilaku_siswa.index', [
    ...
    public function create(): View
    {
        ...
        return view('guru_mapel.perilaku_siswa.create', [
            'siswaList' => $siswaList,
            'perilakuList' => $perilakuList,
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('guru_mapel.perilaku-siswa.index')
    ...
    public function show(PerilakuSiswa $perilakuSiswa): View
    {
        ...
        return view('guru_mapel.perilaku_siswa.show', compact('perilakuSiswa'));
    }
    ...
    public function edit(PerilakuSiswa $perilakuSiswa): View
    {
        ...
        return view('guru_mapel.perilaku_siswa.edit', [
