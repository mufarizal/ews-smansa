<?php
    ...
    if ($arah === 'naik') {
        ...
        $arrowText = 'Naik ' . number_format((float) ($selisih ?? 0), 2);
    } elseif ($arah === 'turun') {
        ...
        $arrowText = 'Turun ' . number_format((float) ($selisih ?? 0), 2);
    } else {
...
<span class="inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-semibold <?php echo e($bg); ?> <?php echo e($color); ?> <?php echo e($border); ?>">
    ...
    <span><?php echo e($arrowText); ?></span>
</span>
<?php /**PATH C:\projects\ews-smansa\resources\views/partials/trend-indicator.blade.php ENDPATH**/ ?>